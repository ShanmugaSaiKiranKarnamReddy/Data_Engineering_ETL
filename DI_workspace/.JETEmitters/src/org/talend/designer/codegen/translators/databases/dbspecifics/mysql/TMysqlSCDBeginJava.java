...
public class TMysqlSCDBeginJava {
  ...
  protected final String TEXT_31 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_32 = " = connection_";
  protected final String TEXT_33 = ".createStatement();" + NL + "            stmtCreate_";
  protected final String TEXT_34 = ".execute(\"";
  protected final String TEXT_35 = "\");" + NL + "            stmtCreate_";
  protected final String TEXT_36 = ".close();";
  protected final String TEXT_37 = NL + "\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_46 = ".toUpperCase();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tString tableName4Search_";
  protected final String TEXT_47 = ";" + NL + "            \tif(tableName4Search_";
  protected final String TEXT_48 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableName4Search_";
  protected final String TEXT_49 = " = tableName4Search_";
  protected final String TEXT_50 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableName4Search_";
  protected final String TEXT_51 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_52 = " = dbMetaData_";
  protected final String TEXT_53 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_54 = ", tableName4Search_";
  ...
  protected final String TEXT_60 = NL + "                java.sql.ResultSet rsTable_";
  protected final String TEXT_61 = ".getTables(";
  protected final String TEXT_62 = ", null, null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_63 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_64 = ".next()) {" + NL + "                    String table_";
  protected final String TEXT_65 = " = rsTable_";
  protected final String TEXT_66 = ".getString(\"TABLE_NAME\");" + NL + "                    if(table_";
  protected final String TEXT_67 = ".equalsIgnoreCase(";
  protected final String TEXT_68 = ")) {" + NL + "                        whetherExist_";
  protected final String TEXT_69 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }";
  protected final String TEXT_70 = NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_71 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_72 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_73 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_74 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_75 = ")) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_76 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }";
  protected final String TEXT_77 = "            " + NL + "            if(!whetherExist_";
  ...
  protected final String TEXT_82 = NL + "        " + NL + "    java.util.Calendar calendar_";
  protected final String TEXT_83 = " = java.util.Calendar.getInstance();" + NL + "    java.util.Calendar calendarYear0_";
  protected final String TEXT_84 = " = java.util.Calendar.getInstance();" + NL + "    " + NL + "    calendar_";
  protected final String TEXT_85 = ".set(1, 0, 1, 0, 0, 0);" + NL + "    calendarYear0_";
  protected final String TEXT_86 = ".set(0,0,0,0,0,0);" + NL + "    " + NL + "    final java.util.Date dateYear0_";
  protected final String TEXT_87 = " = calendarYear0_";
  protected final String TEXT_88 = ".getTime();" + NL + "    final long year1_";
  protected final String TEXT_89 = " = calendar_";
  protected final String TEXT_90 = ".getTime().getTime();" + NL + "    " + NL + "    " + NL + "    calendar_";
  protected final String TEXT_91 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "    final long year10000_";
  protected final String TEXT_92 = ".getTime().getTime();" + NL + "    long date_";
  protected final String TEXT_93 = " = 0;    " + NL + "    String dateStr_";
  protected final String TEXT_94 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_95 = " = null;    ";
  protected final String TEXT_96 = NL + "        String searching_";
  protected final String TEXT_97 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_98 = ".prepareStatement(searching_";
  protected final String TEXT_99 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_100 = " = null;";
  protected final String TEXT_101 = NL + "        String search_";
  protected final String TEXT_102 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_103 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_104 = " = statement_";
  protected final String TEXT_105 = ".executeQuery(search_";
  protected final String TEXT_106 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_107 = ", SCDStruct_";
  protected final String TEXT_108 = "> cache_";
  protected final String TEXT_109 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_110 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_111 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_112 = " sk_";
  protected final String TEXT_113 = " = new SCDSK_";
  protected final String TEXT_114 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_115 = " row_";
  protected final String TEXT_116 = " = new SCDStruct_";
  protected final String TEXT_117 = "();";
  protected final String TEXT_118 = NL + "                    tmpValue_";
  protected final String TEXT_119 = " = resultSet_";
  protected final String TEXT_120 = ".getString(";
  protected final String TEXT_121 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_122 = " != null && tmpValue_";
  protected final String TEXT_123 = ".length() > 0) {";
  protected final String TEXT_124 = NL + "                        ";
  protected final String TEXT_125 = ".";
  protected final String TEXT_126 = " = tmpValue_";
  protected final String TEXT_127 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_128 = NL + "                            if(tmpValue_";
  ...
  protected final String TEXT_133 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_134 = ")) {";
  protected final String TEXT_135 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_136 = "' in '";
  protected final String TEXT_137 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_138 = NL + "                    }";
  protected final String TEXT_139 = NL + "                    dateStr_";
  protected final String TEXT_140 = ");" + NL + "                    if(dateStr_";
  protected final String TEXT_141 = " != null) {" + NL + "                        if(!(\"0000-00-00\").equals(dateStr_";
  protected final String TEXT_142 = ") && !(\"0000-00-00 00:00:00\").equals(dateStr_";
  protected final String TEXT_143 = NL + "                            ";
  protected final String TEXT_144 = " = new java.util.Date(resultSet_";
  protected final String TEXT_145 = ".getTimestamp(";
  protected final String TEXT_146 = ").getTime());" + NL + "                        } else {";
  protected final String TEXT_147 = " = (java.util.Date) dateYear0_";
  protected final String TEXT_148 = ".clone();" + NL + "                        }" + NL + "                    } else {";
  ...
  protected final String TEXT_156 = NL + "            cache_";
  protected final String TEXT_157 = ".put(sk_";
  protected final String TEXT_158 = ", row_";
  protected final String TEXT_159 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_160 = ".close();" + NL + "        statement_";
  protected final String TEXT_161 = NL + "            System.out.println(\"[";
  protected final String TEXT_162 = "] comparison cache loaded\");";
  protected final String TEXT_163 = " nextSurrogateKey_";
  protected final String TEXT_164 = " = 1;";
  protected final String TEXT_165 = NL + "            if(cache_";
  protected final String TEXT_166 = ".size() > 0) {";
  protected final String TEXT_167 = NL + "        String tmpQuery_";
  protected final String TEXT_168 = " = \"SELECT MAX(`";
  protected final String TEXT_169 = "`) FROM `\" + tableName_";
  protected final String TEXT_170 = " + \"`\";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_171 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_172 = " = tmpStmt_";
  protected final String TEXT_173 = ".executeQuery(tmpQuery_";
  protected final String TEXT_174 = NL + "        if(tmpRS_";
  protected final String TEXT_175 = ".next() && tmpRS_";
  protected final String TEXT_176 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_177 = " = tmpRS_";
  protected final String TEXT_178 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_179 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_180 = NL + "            }            ";
  protected final String TEXT_181 = NL + "    String insertionSQL_";
  protected final String TEXT_182 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_183 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_184 = NL + "            insertionStatement_";
  protected final String TEXT_185 = ".setTimestamp(";
  protected final String TEXT_186 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_187 = "\")));";
  protected final String TEXT_188 = ".setNull(";
  protected final String TEXT_189 = ", java.sql.Types.DATE);";
  protected final String TEXT_190 = NL + "            String endDateTimeDetail_";
  protected final String TEXT_191 = ";" + NL + "            String datePattern_";
  protected final String TEXT_192 = " = \"yyyy-MM-dd\";" + NL + "            if(endDateTimeDetail_";
  protected final String TEXT_193 = ".length()>0){" + NL + "            \tendDateTimeDetail_";
  protected final String TEXT_194 = " = \" \"+endDateTimeDetail_";
  protected final String TEXT_195 = ";" + NL + "            \tdatePattern_";
  protected final String TEXT_196 = " = \"yyyy-MM-dd HH:mm:ss\";" + NL + "            }" + NL + "            insertionStatement_";
  protected final String TEXT_197 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(datePattern_";
  protected final String TEXT_198 = ").parse(";
  protected final String TEXT_199 = " + \"-01-01\"+endDateTimeDetail_";
  protected final String TEXT_200 = ").getTime()));";
  protected final String TEXT_201 = NL + "        String updateSQLForType1_";
  protected final String TEXT_202 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_203 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_204 = ");        ";
  protected final String TEXT_205 = NL + "        String updateSQLForType2_";
  protected final String TEXT_206 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_207 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_208 = NL + "            updateForType2_";
  protected final String TEXT_209 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_210 = NL + "        String updateSQLForType3_";
  protected final String TEXT_211 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_212 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_213 = NL + "        SCDSK_";
  protected final String TEXT_214 = " lookUpKey_";
  protected final String TEXT_215 = " = null;        ";
  protected final String TEXT_216 = NL + "    SCDStruct_";
