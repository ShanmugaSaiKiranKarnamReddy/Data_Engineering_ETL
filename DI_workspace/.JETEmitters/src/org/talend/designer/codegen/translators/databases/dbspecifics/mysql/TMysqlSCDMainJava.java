...
public class TMysqlSCDMainJava {
  ...
  protected final String TEXT_24 = " = null;" + NL + "                            } else {" + NL + "                                lookUpValue_";
  ...
  protected final String TEXT_28 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_29 = "' in '";
  protected final String TEXT_30 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_31 = NL + "                    }";
  protected final String TEXT_32 = NL + "                    dateStr_";
  protected final String TEXT_33 = ");" + NL + "                    if(dateStr_";
  protected final String TEXT_34 = " != null) {" + NL + "                        if(!(\"0000-00-00\").equals(dateStr_";
  protected final String TEXT_35 = ") && !(\"0000-00-00 00:00:00\").equals(dateStr_";
  protected final String TEXT_36 = ")) {" + NL + "                            lookUpValue_";
  protected final String TEXT_37 = " = new java.util.Date(searchingResult_";
  protected final String TEXT_38 = ".getTimestamp(";
  protected final String TEXT_39 = ").getTime());" + NL + "                        } else {" + NL + "                            lookUpValue_";
  protected final String TEXT_40 = " = (java.util.Date) dateYear0_";
  protected final String TEXT_41 = ".clone();" + NL + "                        }" + NL + "                    } else {" + NL + "                        lookUpValue_";
  ...
  protected final String TEXT_49 = NL + "        }" + NL + "        searchingResult_";
  protected final String TEXT_50 = ".close();";
  protected final String TEXT_51 = NL + "\ttry {" + NL + "        lookUpKey_";
  protected final String TEXT_52 = " = new SCDSK_";
  protected final String TEXT_53 = NL + "            lookUpKey_";
  protected final String TEXT_54 = " = ";
  protected final String TEXT_55 = ";";
  protected final String TEXT_56 = NL + "        lookUpKey_";
  protected final String TEXT_57 = ".hashCodeDirty = true;" + NL + "        lookUpValue_";
  protected final String TEXT_58 = " = cache_";
  protected final String TEXT_59 = ".get(lookUpKey_";
  protected final String TEXT_60 = ");";
  protected final String TEXT_61 = "    " + NL + "    if(lookUpValue_";
  protected final String TEXT_62 = " == null) {";
  protected final String TEXT_63 = NL + "            lookUpValue_";
  protected final String TEXT_64 = NL + "                lookUpValue_";
  protected final String TEXT_65 = " = 1;";
  protected final String TEXT_66 = NL + "        ";
  protected final String TEXT_67 = NL + "                    ";
  protected final String TEXT_68 = " skRoutine_";
  protected final String TEXT_69 = "                    ";
  protected final String TEXT_70 = NL + "                    nextSurrogateKey_";
  protected final String TEXT_71 = "++;";
  protected final String TEXT_72 = NL + "                ";
  protected final String TEXT_73 = " version_";
  protected final String TEXT_74 = NL + "        nb_line_inserted_";
  protected final String TEXT_75 = " += insertionStatement_";
  protected final String TEXT_76 = ".executeUpdate();";
  protected final String TEXT_77 = NL + "            System.out.println(\"[";
  protected final String TEXT_78 = "] new source id inserted\");";
  ...
  protected final String TEXT_83 = " += updateForType1_";
  protected final String TEXT_84 = NL + "                    System.out.println(\"[";
  protected final String TEXT_85 = "] l1 update done\");";
  protected final String TEXT_86 = NL + "            }";
  protected final String TEXT_87 = " += updateForType2_";
  protected final String TEXT_88 = NL + "                            ";
  protected final String TEXT_89 = NL + "                            nextSurrogateKey_";
  protected final String TEXT_90 = NL + "                        ";
  protected final String TEXT_91 = " maxVersion_";
  protected final String TEXT_92 = " = lookUpValue_";
  protected final String TEXT_93 = " + 1;";
  protected final String TEXT_94 = NL + "                            lookUpValue_";
  protected final String TEXT_95 = " + 1;                            ";
  protected final String TEXT_96 = NL + "                nb_line_inserted_";
  protected final String TEXT_97 = "] new history line\");";
  protected final String TEXT_98 = NL + "                    if (";
  protected final String TEXT_99 = NL + "                   \t} else {" + NL + "                   \t";
  protected final String TEXT_100 = NL + "                   \t}" + NL + "                   \t";
  protected final String TEXT_101 = NL + "                   \t";
  protected final String TEXT_102 = " += updateForType3_";
  protected final String TEXT_103 = "] l3 update done\");";
  protected final String TEXT_104 = NL + "    }" + NL + "    " + NL + "\t} catch (java.lang.Exception e) {//catch" + NL + "  \t\t";
  ...
  protected final String TEXT_110 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_111 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_112 = NL + "                System.err.print(e.getMessage());";
  protected final String TEXT_113 = NL + "\t}//end catch";
  protected final String TEXT_114 = NL + "        cache_";
  protected final String TEXT_115 = ".put(lookUpKey_";
  protected final String TEXT_116 = ", lookUpValue_";
...
if(inputSchema != null && inputSchema.size() > 0 && outputSchema != null && outputSchema.size() > 0) {
    ...
    stringBuffer.append(TEXT_76);
                ...
                paramIndex = 1;
                List<Column> dimensionAttrbites0 = scdConfiger.getDimensionType0Configer().getDimensionAttributes();
                List<String> dimensionNames0 = new ArrayList<String>();
                for(Column dimensionAttrbite : dimensionAttrbites0) {
                    dimensionNames0.add(dimensionAttrbite.getColumnName());
                }
                for(Column insertionColumn : insertionColumnList) {
                    if(insertionColumn.getColumnName().equals(surrogateKeyField)) {
                        if(("INPUT_FIELD").equals(scdConfiger.getSurrogateKeyValueType())) {
    ...
    stringBuffer.append(scdManager.genSetStatement("insertionStatement_" + cid, "maxVersion_" + cid, paramIndex, scdConfiger.getDimensionType2Configer().getVersionFieldType()));
                    ...
                    } else if (dimensionNames0.contains(insertionColumn.getColumnName())){
                            
    stringBuffer.append(TEXT_88);
    stringBuffer.append(scdManager.genSetStatement("insertionStatement_" + cid, "lookUpValue_" + cid + "." + insertionColumn.getLabelName(), paramIndex, insertionColumn.getJavaType()));
