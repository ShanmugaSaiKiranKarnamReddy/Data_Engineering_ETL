...
package data_integration.storeindb_0_1;
 ...
 * @status
 */
public class StoreInDB implements TalendJob {
	...
	private final String jobName = "StoreInDB";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(StoreInDB.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:tbKLedjGlvvap4fGiOT4TW8Hqz4xuYv5BUDMPvuGndbjB/vNqw==");
	...
	public void tMsgBox_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String messagetMsgBox_1 = "Connection successful!";
	...
	public static void main(String[] args) {
		final StoreInDB StoreInDBClass = new StoreInDB();

		int exitCode = StoreInDBClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = StoreInDB.class.getClassLoader()
					.getResourceAsStream("data_integration/storeindb_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = StoreInDB.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StoreInDB");
		}
...
/************************************************************************************************
 * 30690 characters generated by Talend Open Studio for Data Integration on the
 * October 27, 2020 1:06:31 PM CET
 ************************************************************************************************/